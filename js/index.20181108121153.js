...
$('.js-7').attr('src', (dpi>1) ? 'images/group-2-360.png' : 'images/group-2-180.png');
...
$('.js-24').attr('src', 'images/bitmap-259.png');}else{$('.js').attr('src', (dpi>1) ? 'images/1-640.png' : 'images/1-320.png');
$('.js-2').attr('src', (dpi>1) ? 'images/2-420.jpg' : 'images/2-210.jpg');
$('.js-3').attr('src', (dpi>1) ? 'images/-jia-yi-bei-shou-jie-shou-hui-yi-shu-da-sai-122.png' : 'images/-jia-yi-bei-shou-jie-shou-hui-yi-shu-da-sai-61.png');
$('.js-4').attr('src', (dpi>1) ? 'images/xiao-you-fan-xiao-bi-ye-shi-nian-huo-dong-120.png' : 'images/xiao-you-fan-xiao-bi-ye-shi-nian-huo-dong-60.png');
$('.js-5').attr('src', (dpi>1) ? 'images/dsc_1556-by-zhu-xian-yan-118.jpg' : 'images/dsc_1556-by-zhu-xian-yan-59.jpg');
$('.js-6').attr('src', (dpi>1) ? 'images/-yi-chu-hao-xi-15zhou-nian-wan-hui-huo-dong-122.jpg' : 'images/-yi-chu-hao-xi-15zhou-nian-wan-hui-huo-dong-61.jpg');
$('.js-7').attr('src', (dpi>1) ? 'images/group-2-120.png' : 'images/group-2-60.png');
$('.js-8').attr('src', (dpi>1) ? 'images/3-118.jpg' : 'images/3-59.jpg');
